...
export const steps = [
  ...
  },
  {
    number: 2,
    title: "تفاصيل العقار",
    tip: "التفاصيل الدقيقة مثل عدد الغرف والمساحة تساعد المستأجرين في اتخاذ قرارهم بسرعة.",
  },
  {
    number: 3,
    title: "المميزات",
    tip: "اضغط على الأيقونات لتحديد المميزات المتوفرة في الشقة.",
  },
  {
    number: 4,
    title: "الصور ونوع المستأجر",
    tip: "أضف صورًا واضحة واختر نوع المستأجر المفضل لزيادة فرص التأجير.",
  },
];
